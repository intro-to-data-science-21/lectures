...
.footnote[
<sup>1</sup> `summarize()` with an "s" works too. I slightly prefer the barbarian version though.
]
...
There is much, much more in `dplyr`, and we will look beyond these core functions later. Have a glimpse at the [overview at tidyverse.org](https://dplyr.tidyverse.org/) and at this excellent [cheat sheet](https://github.com/rstudio/cheatsheets/blob/master/data-transformation.pdf).
