...
lime-recruitment-kpis-dashboard-geckoboard
bestpass-company-overview-dashboard-geckoboard
https://www.geckoboard.com/dashboard-examples/company/company-dashboard/
https://www.geckoboard.com/dashboard-examples/company/recruitment-dashboard/
...
- Der Sehnsucht nach Dashboards wohnt der Wunsch inne, alles durch Quantifizierung weniger Metriken erklären und entscheiden zu können.
- Das kommt einer groben Simplifizierung der Realität gleich.
- Wenn man Entscheidungen auf Basis von Metriken trifft, hören diese auf gut zu funktionieren (weil sie instrumentalisiert wrden).
- Loss of information crucial for good decision-making when aggregating results into few KPIs
- "Dashboards are not for show. No amount of cuteness and technical wizardry can substitute for clear communication."

Stephen Few, [Perceptual Edge](https://perceptualedge.com)


.pull-right-small-center[

https://stephanieevergreen.com/dashboard-conversation/
https://stephanieevergreen.com/problem-with-dashboards/
http://blogs.ischool.berkeley.edu/i247s12/files/2012/01/Dashboard-Design-Overview-Presentation.pdf
http://perceptualedge.com/library.php
...
- As dashboards are a sub genre of data visualizations, all rules of good data visualization apply.
